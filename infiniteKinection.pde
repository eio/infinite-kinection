 ...
 * - tracks motion captured by Kinect infrared input via a simple frame differencing algorithm
...
void draw() {
  if(calibrating) {
    ...
    // // go ahead and render all the things
    renderTheThings();
  }
